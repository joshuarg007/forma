      ...
      <div className="mb-6">
        ...
        >
          {projects.map((project) => (
            <option key={project.id} value={project.id} className="bg-zinc-900 text-white">
              {project.name}
            </option>
          ))}
        </select>
            ...
            {filteredMembers.length === 0 ? (
              <div className="text-center py-12">
                <div className="relative w-40 h-32 mx-auto mb-3">
                  <Image
                    src="/empty-states/empty-no-team-members.webp"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="editor" className="bg-zinc-900 text-white">Editor - Can edit</option>
                    <option value="viewer" className="bg-zinc-900 text-white">Viewer - Read only</option>
                  </select>
                </div>
