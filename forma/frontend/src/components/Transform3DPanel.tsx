              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    >
                      <option value="center center" className="bg-gray-800 text-white">Center</option>
                      <option value="top center" className="bg-gray-800 text-white">Top</option>
                      <option value="bottom center" className="bg-gray-800 text-white">Bottom</option>
                      <option value="left center" className="bg-gray-800 text-white">Left</option>
                      <option value="right center" className="bg-gray-800 text-white">Right</option>
                      <option value="top left" className="bg-gray-800 text-white">Top Left</option>
                      <option value="top right" className="bg-gray-800 text-white">Top Right</option>
                      <option value="bottom left" className="bg-gray-800 text-white">Bottom Left</option>
                      <option value="bottom right" className="bg-gray-800 text-white">Bottom Right</option>
                    </select>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-violet-500"
                    >
                      <option value="preserve-3d" className="bg-gray-800 text-white">Preserve 3D</option>
                      <option value="flat" className="bg-gray-800 text-white">Flat</option>
                    </select>
                  </div>
                  <div>
