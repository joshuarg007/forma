                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-white focus:border-forma-500 focus:outline-none"
                    >
                      <option value="admin">Admin - Full access</option>
                      <option value="editor">Editor - Edit components</option>
